/* DirectView.c generated by valac 0.40.4, the Vala compiler
...
enum  {
	DIRECT_VIEW_0_PROPERTY,
	DIRECT_VIEW_NUM_PROPERTIES
};
...
static gint64 direct_view_collection_filename_comparator (void* a,
                                                   void* b);
static gint64 _direct_view_collection_filename_comparator_comparator (void* a,
                                                               void* b,
                                                               gpointer self);
...
static DataView* direct_view_collection_direct_view_manager_real_create_view (ViewManager* base,
                                                                       DataSource* source);
ViewManager* view_manager_construct (GType object_type);


DirectView*
direct_view_construct (GType object_type,
                       DirectPhoto* source)
{
...
#line 12 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	self = (DirectView*) data_view_construct (object_type, G_TYPE_CHECK_INSTANCE_CAST (source, TYPE_DATA_SOURCE, DataSource));
#line 14 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	_tmp0_ = media_source_get_file (G_TYPE_CHECK_INSTANCE_CAST (G_TYPE_CHECK_INSTANCE_CAST (source, TYPE_PHOTO, Photo), TYPE_MEDIA_SOURCE, MediaSource));
#line 14 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
...
#line 11 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	return self;
#line 563 "DirectView.c"
}


DirectView*
direct_view_new (DirectPhoto* source)
{
#line 11 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	return direct_view_construct (TYPE_DIRECT_VIEW, source);
#line 572 "DirectView.c"
}
...
#line 581 "DirectView.c"
}


GFile*
direct_view_get_file (DirectView* self)
{
	GFile* result = NULL;
	GFile* _tmp0_;
	GFile* _tmp1_;
...
#line 18 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	return result;
#line 601 "DirectView.c"
}


gchar*
direct_view_get_collate_key (DirectView* self)
{
	gchar* result = NULL;
	const gchar* _tmp0_;
	const gchar* _tmp5_;
...
#line 25 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	return result;
#line 647 "DirectView.c"
}


static void
direct_view_class_init (DirectViewClass * klass)
{
...
#line 660 "DirectView.c"
}


static void
direct_view_instance_init (DirectView * self)
{
#line 7 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
...
#line 671 "DirectView.c"
}


static void
direct_view_finalize (GObject * obj)
{
	DirectView * self;
#line 7 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
...
#line 687 "DirectView.c"
}


GType
direct_view_get_type (void)
{
...
static gint64
_direct_view_collection_filename_comparator_comparator (void* a,
                                                        void* b,
                                                        gpointer self)
{
	gint64 result;
...
#line 39 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	return result;
#line 714 "DirectView.c"
}


DirectViewCollection*
direct_view_collection_construct (GType object_type)
{
...
#line 36 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	return self;
#line 747 "DirectView.c"
}


DirectViewCollection*
direct_view_collection_new (void)
{
#line 36 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	return direct_view_collection_construct (TYPE_DIRECT_VIEW_COLLECTION);
#line 756 "DirectView.c"
}


static gint64
direct_view_collection_filename_comparator (void* a,
                                            void* b)
{
	gint64 result = 0LL;
...
#line 47 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	_tmp0_ = g_strcmp0;
#line 47 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	_tmp1_ = direct_view_get_collate_key (G_TYPE_CHECK_INSTANCE_CAST (aview, TYPE_DIRECT_VIEW, DirectView));
#line 47 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	_tmp2_ = _tmp1_;
#line 47 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	_tmp3_ = direct_view_get_collate_key (G_TYPE_CHECK_INSTANCE_CAST (bview, TYPE_DIRECT_VIEW, DirectView));
#line 47 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	_tmp4_ = _tmp3_;
#line 47 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
...
#line 47 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	return result;
#line 797 "DirectView.c"
}


static DataView*
direct_view_collection_direct_view_manager_real_create_view (ViewManager* base,
                                                             DataSource* source)
{
...
#line 32 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	return result;
#line 818 "DirectView.c"
}


static DirectViewCollectionDirectViewManager*
direct_view_collection_direct_view_manager_construct (GType object_type)
{
...
#line 30 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	return self;
#line 830 "DirectView.c"
}


static DirectViewCollectionDirectViewManager*
direct_view_collection_direct_view_manager_new (void)
{
#line 30 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
	return direct_view_collection_direct_view_manager_construct (DIRECT_VIEW_COLLECTION_TYPE_DIRECT_VIEW_MANAGER);
#line 839 "DirectView.c"
}


static void
direct_view_collection_direct_view_manager_class_init (DirectViewCollectionDirectViewManagerClass * klass)
{
#line 30 "/home/jens/Source/shotwell/src/direct/DirectView.vala"
...
static void
direct_view_collection_direct_view_manager_instance_init (DirectViewCollectionDirectViewManager * self)
{
}


static GType
direct_view_collection_direct_view_manager_get_type (void)
{
...
static void
direct_view_collection_class_init (DirectViewCollectionClass * klass)
{
...
#line 879 "DirectView.c"
}


static void
direct_view_collection_instance_init (DirectViewCollection * self)
{
}


GType
direct_view_collection_get_type (void)
{
